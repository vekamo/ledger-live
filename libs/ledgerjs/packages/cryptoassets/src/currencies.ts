...
export const cryptocurrenciesById: Record<CryptoCurrencyId, CryptoCurrency> = {
  ...
  epic_cash: {
    type: "CryptoCurrency",
    id: "epic_cash",
    coinType: CoinType.EPIC_CASH,
    name: "Epic Cash",
    managerAppName: "Epic Cash",
    ticker: "EPIC",
    scheme: "web+epichttp",
    color: "#BE9A30",
  ...
  epic_cash_floonet: {
    type: "CryptoCurrency",
    id: "epic_cash_floonet",
    coinType: CoinType.EPIC_CASH_FLOONET,
    name: "Epic Cash Floonet",
    managerAppName: "Epic Cash Floonet",
    ticker: "EPIC",
    disableCountervalue: true,
    scheme: "web+epicfloonethttp",
    isTestnetFor: "epic_cash",
    color: "#BE9A30",
    family: "mimblewimble_coin",
    blockAvgTime: 60,
    units: [
  ...
  grin_testnet: {
    type: "CryptoCurrency",
    id: "grin_testnet",
    coinType: CoinType.GRIN_TESTNET,
    name: "Grin Testnet",
  ...
  mimblewimble_coin: {
    ...
    coinType: CoinType.MIMBLEWIMBLE_COIN,
  ...
  mimblewimble_coin_floonet: {
    ...
    coinType: CoinType.MIMBLEWIMBLE_COIN_FLOONET,
